...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(220, 50, 771, 441));
        ...
        textBrowser->setGeometry(QRect(10, 50, 181, 141));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(60, 210, 83, 241));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        AllRestaurants_Button->setText(QApplication::translate("MainWindow", "All Restaurants", nullptr));
