    ...
    ui(new Ui::MainWindow)
{
    ...
    dynamicBox[4] = "Restaurant Stop:\n\nYou may selected what ever you may want from"
                      " each restaurant here. Please press \"Next\" to move to the next"
    ...
    dynamicBox[6] = "Receipt:\n\nYou can veiw your final totals here including"
               ...
               " restaurant. Also, you can view your Grand Total spent and the"
               " total distance traveled during your trip. Please press"
               " \"Close\" when finished.";
